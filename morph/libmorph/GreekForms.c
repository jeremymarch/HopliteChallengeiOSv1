...
Verb verbs[NUM_VERBS] = {
    ...
    { 89, PREFIXED, 18, "ἀποθνήσκω", "ἀποθανοῦμαι", "ἀπέθανον", "τέθνηκα", "", "" },
    ...
    { 97, PREFIXED, 18, "συνῑ́ημι", "συνήσω", "συνῆκα", "συνείκα", "συνεῖμαι", "συνείθην" },
    
    { 98, 0, 19, "αἰσχῡ́νομαι", "αἰσχυνοῦμαι", "", "", "ᾔσχυμμαι", "ᾐσχύνθην" },
    { 99, PREFIXED, 19, "ἀποκρῑ́νομαι", "ἀποκρινοῦμαι", "ἀπεκρῑνάμην", "", "ἀποκέκριμαι", "" },
    { 100, PREFIXED, 19, "ἀπόλλυμι", "ἀπολῶ", "ἀπώλεσα, ἀπωλόμην", "ἀπολώλεκα, ἀπόλωλα", "", "" },
    { 101, 0, 19, "", "ἐρήσομαι", "ἠρόμην", "", "", "" },
    { 102, 0, 19, "εὑρίσκω", "εὑρήσω", "ηὗρον, εὗρον", "ηὗρηκα, εὗρηκα", "ηὕρημαι", "ηὑρέθην" },
    ...
    { 107, CONSONANT_STEM_PERFECT_KAPPA | PREFIXED, 20, "ἀφικνέομαι", "ἀφίξομαι", "ἀφῑκόμην", "", "ἀφῖγμαι", "" },
    ...
    { 111, CONSONANT_STEM_PERFECT_PI, 20, "τρέπω", "τρέψω", "ἔτρεψα, ἐτραπόμην", "τέτροφα", "τέτραμμαι", "ἐτράμην, ἐτρέφθην" },
    { 112, CONSONANT_STEM_PERFECT_SIGMA, 20, "φαίνω", "φανῶ", "ἔφηνα", "πέφηνα, πέφαγκα", "πέφασμαι", "ἐφάνην, ἐφάνθην" },
