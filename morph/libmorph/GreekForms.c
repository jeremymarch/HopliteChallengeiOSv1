...
Verb verbs[NUM_VERBS] = {
    ...
    { 60, CONSONANT_STEM_PERFECT_KAPPA | PREFIXED, 14, "ἐπιδείκνυμαι", "ἐπιδείξομαι", "ἐπεδειξάμην", "", "ἐπιδέδειγμαι", "" },
    ...
    { 77, PREFIXED, 16, "ἐκπῑ́πτω", "ἐκπεσοῦμαι", "ἐξέπεσον", "ἐκπέπτωκα", "", "" },
    ...
    { 80, 0, 16, "πῑ́πτω", "πεσοῦμαι", "ἔπεσον", "πέπτωκα", "", "" },
    ...
    { 102, 0, 19, "εὑρίσκω", "εὑρήσω", "ηὗρον", "ηὕρηκα", "ηὕρημαι", "ηὑρέθην" },
