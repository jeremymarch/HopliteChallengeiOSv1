...
Verb verbs[NUM_VERBS] = {
    ...
    { 42, 0, 12, "ἀποδίδωμι", "ἀποδώσω", "ἀπέδωκα", "ἀποδέδωκα", "ἀποδέδομαι", "ἀπεδόθην" },
...
Ending endings[NUM_ENDINGS] = {
    ...
    { 0, 9, 0, 0, 0, "ῶμαι", "ᾷ", "ᾷται", "ώμεθα", "ᾶσθε", "ῶνται", "" },   //pres mid/pass indic a
    ...
    { 0, 9, 0, 0, 0, "ῶμαι", "ᾷ", "ᾷται", "ώμεθα", "ᾶσθε", "ῶνται", "" },   //pres mid/pass subj a
