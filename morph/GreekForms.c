...
Verb verbs[NUM_VERBS] = {
    ...
    { 15, CONSONANT_STEM_PERFECT_3, 5, "πρᾱ́ττω", "πρᾱ́ξω", "ἔπρᾱξα", "πέπρᾱγα, πέπρᾱχα", "πέπρᾱγμαι", "ἐπρᾱ́χθην" },
    ...
    { 22, 0, 7, "σῴζω", "σώσω", "ἔσωσα", "σέσωκα", "σέσωσμαι, σέσωμαι", "ἐσώθην" },
    ...
    { 32, 0, 10, "ἀξιόω", "ἀξιώσω", "ἠκίωσα", "ἠξίωκα", "ἠξίωμαι", "ἠξιώθην" },
    ...
    { 40, 0, 11, "δέχομαι", "δέξομαι", "ἐδεξάμην", "", "δέδεγμαι", "" },
    { 41, CONSONANT_STEM_PERFECT_3, 11, "ἀποδέχομαι", "ἀποδέξομαι", "ἀπεδεξάμην", "", "ἀποδέδιγμαι", "" },
